                ...
                <div class="modal-body">
                  <form class="" action="delete_mapel.php" method="get">
                    <div class="form-group">
                      ...
                      <input type="hidden" name="kodemapel" class="form-control" value="<?php echo $row['kode_mapel']; ?>">
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-body">
                  <form class="" action="edit_mapel.php" method="get">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="namamapel" class="form-control" value="<?php echo $row['nama_mapel']; ?>">
                    </div>
                    <div class="form-group">
